...
**For information on new developments, visit the [pull requests](https://github.com/partnerhero/gapi-script/pulls) and [issues](https://github.com/partnerhero/gapi-script/issues) sections from the upstream.**
